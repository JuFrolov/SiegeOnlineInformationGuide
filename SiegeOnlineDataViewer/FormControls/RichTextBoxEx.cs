...
namespace SiegeOnlineDataViewer.FormControls
{
	public class RichTextBoxEx : RichTextBox
	{
		...
		public void InsertLink(string text, string hyperlink, int position)
		{
			...
			byte[] bt = Encoding.GetEncoding(1251).GetBytes(text);
			foreach (byte b in bt)
				sb.Append(b < 128 ? ((char)b).ToString() : "\\'" + b.ToString("x"));

			this.SelectedRtf = string.Format(@"{{\rtf1\ansi\ansicpg1251\deff0\deflang1049 {0}\v #{1}\v0}}", sb, hyperlink);
		...
		public void AddLink(string text, string hyperlink)
		{
		...
		public void AddText(string str, Font font, Color color)
		{
			var tmp = SelectionFont;
			var tmp2 = SelectionColor;
		...
		public void AddLine(string str, Font font, Color color)
		{
